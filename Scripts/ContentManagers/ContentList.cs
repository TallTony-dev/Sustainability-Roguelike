...
namespace Monogame_Cross_Platform.Scripts.ContentManagers
{
    internal class ContentList
    {
        ...
        public List<(string textureName, Rectangle sourceRect, ushort index)> GetAlwaysLoaded()
        {
            LoadTileSet(AlwaysLoadedTileSets, AlwaysLoadedToLoad);
        ...
        /// </summary>
        public void LoadTileSet((string textureName, ushort startingIndex)[] tileSetToLoad, List<(string textureName, Rectangle sourceRect, ushort index)> TileListToLoad)
        {
